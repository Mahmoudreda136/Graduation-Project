...
class PropertyRentPage extends StatefulWidget {
  ...
  @override
  _PropertyRentPageState createState() => _PropertyRentPageState();
}
...
class _PropertyRentPageState extends State<PropertyRentPage> {
  ...
  void initState() {
    super.initState();
    properties = RegionData.properties[widget.destination]?['For Rent'] ?? [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Rentals in ${widget.destination}"),
        leading: IconButton(
